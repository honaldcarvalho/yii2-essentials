...
class m250926_181500_seed_sys_menus extends Migration
{
    ...
    private array $items = [
        ...
        ['label' => 'Post Section',    'parent' => null, 'icon' => 'fas fa-circle',              'icon_style' => 'fas', 'url' => '/post-section/index',     'order' => 2,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\PostSectionController', 'action' => 'index', 'active' => 'post-section', 'visible' => 'blog\\admin\\controllers\\PostSectionController;index'],
        ['label' => 'Post',            'parent' => null, 'icon' => 'fas fa-newspaper',           'icon_style' => 'fas', 'url' => '/post/index',             'order' => 3,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\PostController',        'action' => '',      'active' => 'post',        'visible' => 'blog\\admin\\controllers\\PostController;index'],
        ['label' => 'Tags',            'parent' => null, 'icon' => 'fas fa-tags',                'icon_style' => 'fas', 'url' => '/tag/index',              'order' => 4,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\PostController',        'action' => '',      'active' => 'post',        'visible' => 'blog\\admin\\controllers\\PostController;index'],
        ['label' => 'Faq Section',     'parent' => null, 'icon' => 'fas fa-circle',              'icon_style' => 'fas', 'url' => '/faq-section/index',      'order' => 5,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\FaqSectionController', 'action' => 'index', 'active' => 'faq-section', 'visible' => 'blog\\admin\\controllers\\FaqSectionController;index'],
        ['label' => 'Faq',             'parent' => null, 'icon' => 'far fa-question-circle',     'icon_style' => 'fas', 'url' => '/faq/index',              'order' => 6,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\FaqController',        'action' => '',      'active' => 'faq',         'visible' => 'blog\\admin\\controllers\\FaqController;index'],
        ['label' => 'Banner',          'parent' => null, 'icon' => 'far fa-image',               'icon_style' => 'fas', 'url' => '/banner/index',           'order' => 7,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\BannerController',     'action' => '',      'active' => 'banner',      'visible' => 'blog\\admin\\controllers\\BannerController;index'],
        ['label' => 'Page Header',     'parent' => null, 'icon' => 'fas fa-circle',              'icon_style' => 'fas', 'url' => '/page-header/index',      'order' => 8,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\PageHeaderController', 'action' => 'index', 'active' => 'page-header', 'visible' => 'blog\\admin\\controllers\\PageHeaderController;index'],
        ['label' => 'Contact',         'parent' => null, 'icon' => 'fas fa-envelope',            'icon_style' => 'fas', 'url' => '/contact/index',          'order' => 9,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'blog\\admin\\controllers\\ContactController',   'action' => '',      'active' => 'contact',     'visible' => 'blog\\admin\\controllers\\ContactController;index'],
    ];
