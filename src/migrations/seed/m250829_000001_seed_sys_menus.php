...
class m250829_000001_seed_sys_menus extends Migration
{
    ...
    private array $items = [
        ...
        ['label' => 'Dinamic Forms',   'parent' => 'System', 'icon' => 'fas fa-file-alt',        'icon_style' => 'fas', 'url' => '#',                        'order' => 3,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => null,                                           'action' => null,   'active' => null,          'visible' => null],
        ...
        ['label' => 'Tags',            'parent' => 'Dinamic Pages', 'icon' => 'fas fa-tags',     'icon_style' => 'fas', 'url' => '/tag/index',              'order' => 5,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'croacworks\\essentials\\controllers\\TagController',         'action' => 'index', 'active' => null,          'visible' => 'index'],

        // Children of Dinamic Forms
        ['label' => 'Dynamic Forms',   'parent' => 'Dinamic Forms', 'icon' => '',                'icon_style' => 'fas', 'url' => '/dynamic-form/index',     'order' => 3,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'croacworks\\essentials\\controllers\\DynamicFormController', 'action' => 'index', 'active' => 'page-section','visible' => 'croacworks\\essentials\\controllers\\DynamicFormController;index'],
        ['label' => 'Form Fields',     'parent' => 'Dinamic Forms', 'icon' => 'fas fa-tags',     'icon_style' => 'fas', 'url' => '/form-field/index',       'order' => 5,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'croacworks\\essentials\\controllers\\FormFieldController',   'action' => 'index', 'active' => null,          'visible' => 'index'],
        ['label' => 'Form Responses',  'parent' => 'Dinamic Forms', 'icon' => 'fas fa-file',     'icon_style' => 'fas', 'url' => '/form-response/index',    'order' => 5,   'only_admin' => 0, 'status' => 1, 'show' => 1, 'controller' => 'croacworks\\essentials\\controllers\\FormResponseController','action' => 'index', 'active' => null,          'visible' => 'index'],
