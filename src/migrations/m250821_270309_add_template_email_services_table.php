...
class m250821_270309_add_template_email_services_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        <head>
            ...
            <style>
            /* --- CoreUI Dark (cores custom) --- */
            body {
                background-color: #212631; /* body bg dark */
            ...
            .body { background-color: #212631; width: 100%; }
            ...
            .main {
                background:#323a49;           /* card bg dark */
                border-radius:6px;
                width:100%;
            }
            ...
            <tr>
                ...
                <div class="content">
                    ...
                    <tr>
                        ...
                        <a href="https://{{company_host}}" target="_blank" rel="noopener noreferrer" style="display:inline-block">
                    ...
                    <tr>
                        ...
                        <!-- Bloco de conteúdo específico do e-mail -->
                        {{content}}
                    ...
                    <div class="footer">
                    <p>
                        <strong>{{company_title}}</strong> — {{company_slogan}}<br/>
                        {{company_name}} · <a href="mailto:{{company_email}}" style="color:#6b7785;">{{company_email}}</a> · {{company_host}}
                    </p>
